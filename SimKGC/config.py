...
parser.add_argument('--task', default='wn18rr', type=str, metavar='N',
                    help='dataset name')
parser.add_argument('--train-path', default='/home/horanchen/ydy/study/code/0SimKGC/data/WN18RR/train.txt.json', type=str, metavar='N',
                    help='path to training data')
parser.add_argument('--valid-path', default='/home/horanchen/ydy/study/code/0SimKGC/data/WN18RR/test.txt.json', type=str, metavar='N',
                    help='path to valid data')
parser.add_argument('--model-dir', default='/home/horanchen/ydy/study/code/0SimKGC/data/WN18RR/checkpoint_runtime/', type=str, metavar='N',
...
parser.add_argument('--eval-model-path', default='/home/horanchen/ydy/study/code/0SimKGC/data/WN18RR/checkpoint_runtime/model_best.mdl', type=str, metavar='N',
